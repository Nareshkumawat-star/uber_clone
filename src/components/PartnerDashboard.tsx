...
import { ShieldCheck, Car as CarIcon, MapPin as MapPinIcon } from 'lucide-react'
...
function PartnerDashboard() {
    ...
    useEffect(() => {
        ...
        socket.on('new_ride_request', (data) => {
           console.log('Incoming ride in Onboarding Dashboard:', data);
    ...
    return (
        <div className="w-full min-h-screen bg-white flex flex-col items-center py-12 px-4">
            ...
            {/* Incoming Ride Overlay Modal (Mirrored for testing) */}
            {incomingRide && !activeRide && (
                ...
                >
                    ...
                    <div className="bg-gray-50 rounded-2xl p-4 space-y-4 mb-6 border border-gray-100 text-left">
            ...
            {activeRide && (
                <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-40 bg-green-500 text-white px-6 py-4 rounded-full shadow-2xl flex items-center gap-4 animate-bounce">
                    <div className="bg-white/20 p-2 rounded-full"><CarIcon size={20} /></div>
                    <div>
